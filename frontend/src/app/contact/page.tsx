  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-indigo-500 via-blue-400 to-purple-400 dark:from-gray-900 dark:via-indigo-900 dark:to-purple-900 relative">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 z-10 relative">
        <div className="bg-white/90 dark:bg-gray-900/80 rounded-2xl p-8 md:p-12 shadow-2xl max-w-2xl w-full">
          {submitted ? (
            <div>
              <h1 className="text-4xl font-bold text-indigo-700 dark:text-indigo-300 mb-4">Thank You!</h1>
              <p className="text-lg text-gray-700 dark:text-gray-300">Your message has been sent. We&apos;ll get back to you as soon as possible.</p>
            ...
            <>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">Have a question about our Enterprise plan or anything else? Let us know!</p>
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                <input
                  type="text"
                  placeholder="Your Name"
                  className="w-full px-4 py-3 rounded-lg bg-gray-100 dark:bg-gray-800 border-2 border-transparent focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  required
                />
                <input
                  type="email"
