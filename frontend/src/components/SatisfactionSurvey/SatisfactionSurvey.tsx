                  ...
                  <button
                    ...
                    className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-200 ${
                      answers[currentQ.id] === rating
                        ...
                        : 'bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 hover:bg-blue-100 dark:hover:bg-blue-900/20'
                    }`}
                  >
            ...
            {currentQuestion === questions.length - 1 && (
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-neutral-800 dark:text-white"
                  rows={3}
                />
              </div>
            )}
