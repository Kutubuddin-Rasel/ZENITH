...
export default function InsightsDashboard({
    ...
    const [daysLookback, setDaysLookback] = useState(30); // Note: server data is pre-fetched with default 30. 
    // Optimization TODO: Changing this state should trigger a server refetch via router.refresh() or params update. 
    // For this refactor, we acknowledge the limitation: changing lookback strictly client-side won't update server data unless we sync to URL.
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="sticky top-0 z-40 -mx-4 lg:-mx-6 px-4 lg:px-6 py-3 bg-neutral-50/95 dark:bg-[#0a0a0a]/95 backdrop-blur-lg border-b border-neutral-200/50 dark:border-neutral-800/50">
                <div className="flex flex-col md:flex-row items-center justify-between gap-3">
                    {/* Navigation Tabs */}
                    <div className="flex overflow-x-auto pb-2 md:pb-0 scrollbar-hide w-full md:w-auto">
                        <div className="flex items-center gap-2 p-1.5 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm">
                            {TABS.map((tab) => {
                                const Icon = tab.icon;
                                ...
                                return (
                                    <button
                                        ...
                                        className={`relative flex items-center gap-2.5 px-6 py-2.5 rounded-xl font-medium text-sm transition-all duration-300 outline-none ${isActive ? 'text-white' : 'text-neutral-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-200'
                                            }`}
                                    >
                                        {isActive && (
                                            <motion.div
                    ...
                    {/* Date Selector */}
                    <div className="flex items-center gap-2 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl p-1.5 rounded-2xl shadow-sm border border-neutral-200 dark:border-neutral-800">
                        {[14, 30, 90].map((days) => (
                            <button
                                key={days}
                    ...
                    {activeTab === 'overview' && (
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <motion.div variants={itemVariants} className="md:col-span-2">
                                <Card className="h-full p-5 border-none shadow-lg bg-gradient-to-br from-white to-neutral-50 dark:from-neutral-900 dark:to-neutral-950 relative overflow-hidden group">
                                    ...
                                    <div className="flex justify-between items-start relative z-10">
                                        <div>
                                            <div className="flex items-center gap-3 mb-2">
                                                ...
                                                <Typography variant="h3" className="font-bold text-neutral-900 dark:text-white">Sprint Health</Typography>
                                            </div>
                                            <p className="text-neutral-500 max-w-xs mt-2 text-sm leading-relaxed">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <div className="text-sm font-medium text-neutral-400 mt-1 uppercase tracking-wider">Score</div>
                                        </div>
                                    </div>
                                    {/* Progress Bar */}
                            ...
                            <motion.div variants={itemVariants} className="md:col-span-1">
                                <Card className="h-full p-4 border border-neutral-100 dark:border-neutral-800 bg-white dark:bg-neutral-900 hover:shadow-lg transition-all duration-300">
                                    ...
                                    <div className="space-y-1">
                                        <Typography className="text-sm text-neutral-500">Average Velocity</Typography>
                                        <div className="text-3xl font-bold text-neutral-900 dark:text-white">{velocityAverage.toFixed(0)}</div>
                            ...
                            <motion.div variants={itemVariants} className="md:col-span-1">
                                <Card className="h-full p-4 border border-neutral-100 dark:border-neutral-800 bg-white dark:bg-neutral-900 hover:shadow-lg transition-all duration-300">
                                    ...
                                    <div className="space-y-1">
                                        <Typography className="text-sm text-neutral-500">Avg Cycle Time</Typography>
                                        <div className="text-3xl font-bold text-neutral-900 dark:text-white">{cycleTimeData?.averageDays ?? '--'} <span className="text-base text-neutral-400 font-normal">days</span></div>
                                ...
                                <Card className="h-full p-5 border-none shadow-lg bg-white dark:bg-neutral-900">
                                    <div className="flex items-center justify-between mb-4">
                                        <div>
                                            ...
                                            <p className="text-sm text-neutral-500 mt-1">Real-time tracking of sprint completion</p>
                                        </div>
                                    ...
                                    <div className="h-[180px] w-full">
                                        {burndownData && burndownData.length > 0 ? (
                                            <div className="space-y-3">
                                                ...
                                                <div className="h-6 w-full bg-neutral-100 dark:bg-neutral-800 rounded-full overflow-hidden flex">
                                                    <motion.div
                                                        initial={{ width: 0 }}
                                            ...
                                            <div className="flex items-center justify-center h-full">
                                                <div className="text-center">
                                                    <RocketLaunchIcon className="h-10 w-10 text-neutral-300 mx-auto mb-2" />
                                                    <p className="text-sm text-neutral-400">No active sprint</p>
                                                </div>
                                            </div>
                                        )}
                                    </div>
                            ...
                            <motion.div variants={itemVariants}>
                                {riskData ? (
                                    ...
                                    <Card className="p-6 h-full flex flex-col items-center justify-center text-center">
                                        <FireIcon className="h-12 w-12 text-neutral-300 mb-4" />
                                        <Typography className="text-neutral-500">No active sprint for risk analysis</Typography>
                                    </Card>
                                )}
                            </motion.div>
                        </div>
                            ...
                            <motion.div variants={itemVariants}>
                                <Card className="p-5 border-none shadow-lg">
                                    <div className="mb-6 flex justify-between items-center">
                                        ...
                                        <div className="flex gap-4">
                                            <div className="text-center">
                                                <div className="text-sm text-neutral-500">P50</div>
                                                <div className="font-bold text-purple-600">{cycleTimeData?.p50Days ?? '--'}d</div>
                                            </div>
                                            <div className="text-center">
                                                <div className="text-sm text-neutral-500">P95</div>
                                ...
                                <Card className="p-5 h-full border-none shadow-lg">
                                    ...
                                    <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                                        {epicProgressData?.map((epic) => (
                                            <div key={epic.epicId} className="p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-xl hover:bg-white dark:hover:bg-neutral-800 transition-colors shadow-sm">
