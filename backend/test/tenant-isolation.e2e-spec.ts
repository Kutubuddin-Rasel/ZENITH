...
describe('Tenant Isolation (Red Team Test)', () => {
    ...
    beforeAll(async () => {
        ...
        console.log(`Test tables: test_orgs_${TEST_RUN_ID}, test_projects_${TEST_RUN_ID}`);
    ...
    afterAll(async () => {
        ...
        try {
            if (dataSource?.isInitialized) {
                ...
                await dataSource.query(`DROP TABLE IF EXISTS "test_projects_${TEST_RUN_ID}" CASCADE`);
                await dataSource.query(`DROP TABLE IF EXISTS "test_orgs_${TEST_RUN_ID}" CASCADE`);
