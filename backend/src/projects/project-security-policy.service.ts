...
export class ProjectSecurityPolicyService {
    ...
    private policyCache: Map<string, { policy: ProjectSecurityPolicy; timestamp: number }> = new Map();
    ...
    async update(
        projectId: string,
        userId: string,
        updates: Partial<Omit<ProjectSecurityPolicy, 'id' | 'projectId' | 'createdAt' | 'updatedAt'>>,
