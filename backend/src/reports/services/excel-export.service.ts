...
export class ExcelExportService {
    ...
    async generateIssueBreakdownExcel(
        ...
        summarySheet.addRow({ metric: 'Total Issues', value: data.totalIssues }).commit();
        summarySheet.commit();
        ...
        const breakdowns: Array<{
            ...
            keyLabel: string;
                ...
                { name: 'By Priority', data: data.priorityBreakdown, keyLabel: 'Priority' },
                { name: 'By Status', data: data.statusBreakdown, keyLabel: 'Status' },
                { name: 'By Assignee', data: data.assigneeBreakdown, keyLabel: 'Assignee' },
            ];
