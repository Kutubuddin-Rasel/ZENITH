    ...
    async canActivate(context: ExecutionContext): Promise<boolean> {
        ...
        if (projectId) {
            ...
            if (!roleName) {
                ...
                if (roleName) {
                    await this.cacheService.set(cacheKey, roleName, { ttl: this.CACHE_TTL });
                }
            }
            ...
            const projectPermissionsMap: Record<string, string[]> = {
                ProjectLead: [
                    ...
                    'members:view', 'members:add', 'members:remove',
                    'invites:create', 'issues:create', 'issues:view', 'issues:update', 'issues:delete',
                    'sprints:create', 'sprints:view', 'sprints:update', 'sprints:delete',
                    'comments:create', 'comments:view', 'comments:update', 'comments:delete',
                    'attachments:create', 'attachments:view', 'attachments:delete',
                    'boards:create', 'boards:view', 'boards:update', 'boards:delete',
                    'columns:create', 'columns:update', 'columns:delete',
                    'releases:create', 'releases:view', 'releases:update', 'releases:delete',
                    'labels:create', 'labels:view', 'labels:update', 'labels:delete',
                    'components:create', 'components:view', 'components:update', 'components:delete',
                    'epics:create', 'epics:view', 'epics:update', 'epics:delete',
                    'stories:create', 'stories:view', 'stories:update', 'stories:delete',
                    'backlog:view', 'backlog:update', 'watchers:view', 'watchers:update',
                ],
                Member: [
                    'projects:view', 'issues:create', 'issues:view', 'issues:update',
                    'invites:view', 'sprints:view',
                    'comments:create', 'comments:view', 'comments:update',
                    'attachments:create', 'attachments:view', 'boards:view',
                    'releases:view', 'labels:view', 'components:view',
                    'labels:update', 'components:update',
                    'epics:view', 'stories:create', 'stories:view', 'stories:update',
                    'backlog:view', 'watchers:view', 'watchers:update',
                ],
                Viewer: [
                    'projects:view', 'issues:view', 'invites:view',
                    'sprints:view', 'comments:view', 'comments:create',
                    'attachments:view', 'boards:view', 'releases:view',
                    'labels:view', 'components:view', 'epics:view',
                    'stories:view', 'backlog:view', 'watchers:view',
                ],
            };
