...
describe('ConversationManagerService', () => {
    ...
    describe('Criteria Management', () => {
        it('should update criteria in context', async () => {
            ...
            service.updateCriteria(
                context,
                {
                    projectType: 'mobile_development' as Parameters<typeof service.updateCriteria>[1]['projectType'],
                    teamSize: '2-5' as Parameters<typeof service.updateCriteria>[1]['teamSize'],
                },
                createEmptyConfidence(),
            );
    ...
    describe('Missing Criteria Detection', () => {
        ...
        it('should return empty array when all criteria present', async () => {
            const criteria = createEmptyCriteria();
            criteria.projectType = 'website_development' as typeof criteria.projectType;
        ...
        it('should correctly identify partially filled criteria', async () => {
            const criteria = createEmptyCriteria();
            criteria.projectType = 'website_development' as typeof criteria.projectType;
